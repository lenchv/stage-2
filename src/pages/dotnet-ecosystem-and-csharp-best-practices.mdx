...
<div>
  ...
  <strong>
    ...
    <img src="/assets/images/dorov.png" alt="Composer logo" style={{
...
<div class="presentation-block">
  <iframe
    ...
    src="https://slides.com/diakivrostyslav/dotnet-ecostystem/embed"
    width="100%"
    height="600"
    scrolling="no"
    frameborder="2"
...
<ul>
  <li class="details">
    ...
    <div class="details-body" style="margin-bottom: 0.5em;">
      <p>Сьогодні у <strong>.NET</strong> світі 3 найпоширеніші мови програмування це <strong>C#</strong>, `F#` та `Visual Basic`. У кожної є свій компілятор, який перетворює код написаний на цій мові у `IL - Intermediate Language Code`, який представляє з себе набір інструкцій для віртуальної машини <strong>.NET</strong> - `CLR - Common Language Runtime`. Основні етапи виконання програми <strong>.NET</strong>:</p>
      <ol>
        <li>Спочатку написаний нами код, компілятор перетворить C# code на IL.</li>
      ...
      <p>Важливо зазначити, що перетворення `IL` в `машинний код` відбувається лише тоді коли потрібно, тобто буде перетворена тільки та частина коду, яка має виконатись в теперішній момент часу. Результатом білда <strong>.NET</strong> програми є файл з розширенням `.exe` - executable файл, або: `dll` - `Dynamic Link Library`.</p>
    </div>
  </li>
  <li class="details">
    <input type="checkbox" id="accordion-2-2" />
    <label class="summary" for="accordion-2-2">
      <h5><strong>C# → IL Code</strong></h5>
    </label>
    <div class="details-body" style="margin-bottom: 0.5em;">
      <p>Результат компіляції функції, написаної на <strong>C#</strong> у проміжну мову **IL**:
      // TODO: тут потрібно просто вставити 2 сніппети коду</p>
    </div>
  </li>
  <li class="details">
  ...
  <li class="details">
    ...
    <div class="details-body" style="margin-bottom: 0.5em;">
      <p>Важливий момент у тому, як змінні `Значимих` та `Ссилочних` типів передаються у метод.
      // TODO: тут потрібно просто вставити 4 сніппети коду</p>
    </div>
  </li>
  <li class="details">
    <input type="checkbox" id="accordion-2-6" />
...
<ThatsAllFolks />
<div class="bubble">
  Отже, здається це все, про що я хотів розповісти на цій лекції. Дякую за увагу, ставте лайки, робіть домашку, до зустрічі! 👋
</div>
