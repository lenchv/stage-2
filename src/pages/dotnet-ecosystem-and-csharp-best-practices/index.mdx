...
<ul>
  ...
  <li class="details">
    ...
    <div class="details-body" style="margin-bottom: 0.5em;">
      <p>Використовуючи ключове слово <code>params</code> ми можемо "сказати" параметру конкретного методу, яку кількість аргументів він примає — це може бути нуль або більше, будь-яка кількість. Далі ці аргументи можна використовувати у контексті масиву.</p>
      <SnippetL03S02 />
