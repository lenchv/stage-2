...
<ul>
  ...
  <li class="details">
    ...
    <div class="details-body" style="margin-bottom: 0.5em;">
      ...
      <p>Базовим для всіх типів <em>еxception</em>-ів є тип <code>Exception</code>. Цей тип визначає ряд властивостей, за допомогою яких можна отримати інформацію про <em>exception</em>:</p>
      <ul>
      <li><code>InnerException</code> зберігає інформацію про <code>Exception</code>, через який виник цей <code>Exception</code></li>
      <li><code>Message</code> зберігає повідомлення про <code>Exception</code>, текст помилки</li>
      <li><code>Source</code> зберігає ім'я об'єкта або збірки, яка викинула <code>Exception</code></li>
      <li><code>StackTrace</code> повертає колл стек викликів, які привели до <code>Exception</code>-а</li>
