...
<Level id="basic-javascript" number="1" name="Basic JavaScript" difficulty="I Can Win." objectives="Get to the &#x1F681; Internet! Learn the GitHub platfrom while you're at it." />
...
<Level id="building-a-page-with-es6" number="2" name="Building a page with ES6" difficulty="Bring It On!" objectives="Master issues and project management." />
...
<Level id="modules-transpiling-bundling-etc" number="3" name="Modules, transpiling, bundling, etc." difficulty="Hurt Me Plenty." objectives="N/A" />
