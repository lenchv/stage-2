...
1. **Ready to try [JavaScript](https://www.javascript.com/)?**
    ...
    <span class="chip">Brendan Eich</span><span class="chip">EcmaScript</span><span class="chip">script language</span><span class="chip">dynamic language</span><span class="chip">dynamically typed</span><span class="chip">first-class functions</span><span class="chip">object-oriented</span><span class="chip">prototype-based</span><span class="chip">asynchronous</span><span class="chip">single-threaded</span>
