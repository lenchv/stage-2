...
```
  ...
  <li>
    ...
    <ul class="collapsible">
      <li>
        <div class="accordion">
          <input type="checkbox" id="accordion-3-1" hidden />
          <label class="accordion-header" for="accordion-3-1">
            <span className="icon">
...
```
      ...
      <li>
        <div class="accordion">
          <input type="checkbox" id="accordion-3-2" hidden />
          <label class="accordion-header" for="accordion-3-2">
            <span className="icon">
              <FontAwesomeIcon icon={faCaretRight} fixedWidth />
            </span>
...
```
      ...
      <li>
        <div class="accordion">
          <input type="checkbox" id="accordion-3-3" hidden />
          <label class="accordion-header" for="accordion-3-3">
            <span className="icon">
              <FontAwesomeIcon icon={faCaretRight} fixedWidth />
            </span>
...
```
  ...
  <li>
    ...
    <ul class="collapsible">
      <li>
        <div class="accordion">
          <input type="checkbox" id="accordion-4-1" hidden />
          <label class="accordion-header" for="accordion-4-1">
            <span className="icon">
              <FontAwesomeIcon icon={faCaretRight} fixedWidth />
            </span>
...
```
      ...
      <li>
        <div class="accordion">
          <input type="checkbox" id="accordion-4-2" hidden />
          <label class="accordion-header" for="accordion-4-2">
            <span className="icon">
              <FontAwesomeIcon icon={faCaretRight} fixedWidth />
            </span>
...
```
      ...
      <li>
        <div class="accordion">
          <input type="checkbox" id="accordion-4-3" hidden />
          <label class="accordion-header" for="accordion-4-3">
            <span className="icon">
              <FontAwesomeIcon icon={faCaretRight} fixedWidth />
            </span>
...
```
      ...
      <li>
        <div class="accordion">
          <input type="checkbox" id="accordion-4-4" hidden />
          <label class="accordion-header" for="accordion-4-4">
            <span className="icon">
              <FontAwesomeIcon icon={faCaretRight} fixedWidth />
            </span>
            <strong>null</strong>
...
```
      ...
      <li>
        <div class="accordion">
          <input type="checkbox" id="accordion-4-5" hidden />
          <label class="accordion-header" for="accordion-4-5">
            <span className="icon">
              <FontAwesomeIcon icon={faCaretRight} fixedWidth />
            </span>
...
```
      ...
      <li>
        <div class="accordion">
          <input type="checkbox" id="accordion-4-6" hidden />
          <label class="accordion-header" for="accordion-4-6">
            <span className="icon">
              <FontAwesomeIcon icon={faCaretRight} fixedWidth />
            </span>
    ...
    <ul>
      ...
      <li>
        ...
        <ul class="collapsible">
          <li>
            <div class="accordion">
              <input type="checkbox" id="accordion-6-1" hidden />
              <label class="accordion-header" for="accordion-6-1">
                <span className="icon">
                  <FontAwesomeIcon icon={faCaretRight} fixedWidth />
                </span>
...
```
          ...
          <li>
            <div class="accordion">
              <input type="checkbox" id="accordion-6-2" hidden />
              <label class="accordion-header" for="accordion-6-2">
                <span className="icon">
                  <FontAwesomeIcon icon={faCaretRight} fixedWidth />
                </span>
...
```
  ...
  <li>
    ...
    <ul class="collapsible">
      <li>
        <div class="accordion">
          <input type="checkbox" id="accordion-7-1" hidden />
          <label class="accordion-header" for="accordion-7-1">
            <span className="icon">
              <FontAwesomeIcon icon={faCaretRight} fixedWidth />
            </span>
...
```
      ...
      <li>
        <div class="accordion">
          <input type="checkbox" id="accordion-7-2" hidden />
          <label class="accordion-header" for="accordion-7-2">
            <span className="icon">
              <FontAwesomeIcon icon={faCaretRight} fixedWidth />
            </span>
...
```
      ...
      <li>
        <div class="accordion">
          <input type="checkbox" id="accordion-7-3" hidden />
          <label class="accordion-header" for="accordion-7-3">
            <span className="icon">
              <FontAwesomeIcon icon={faCaretRight} fixedWidth />
            </span>
...
```
      ...
      <li>
        <div class="accordion">
          <input type="checkbox" id="accordion-7-4" hidden />
          <label class="accordion-header" for="accordion-7-4">
            <span className="icon">
              <FontAwesomeIcon icon={faCaretRight} fixedWidth />
            </span>
...
```
      ...
      <li>
        <div class="accordion">
          <input type="checkbox" id="accordion-7-5" hidden />
          <label class="accordion-header" for="accordion-7-5">
            <span className="icon">
              <FontAwesomeIcon icon={faCaretRight} fixedWidth />
            </span>
