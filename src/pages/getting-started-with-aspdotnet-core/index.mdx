...
<div>
  <div class="author">
    ...
    <div class="profile">
      ...
      <p class="about">
        Нікіта працює бекенд-розробником в <a href="https://binary-studio.com"><strong>Binary Studio</strong></a>. Категорично не вживає алкоголю, зате впевнено вживає .NET-фреймворки, електронну музику, функціональне програмування і футболки з прінтами мемів. Відвідує технічні мітапи та конференції і вам радить спробувати — після завершення домашнього завдання для цієї лекції 😉.
      </p>
    </div>
  </div>
