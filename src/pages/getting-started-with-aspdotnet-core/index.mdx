...
<ThatsAllFolks />
<div class="bubble">
  Вот так вот вкратце об ASP.NET Core. На этом всё, спасибо большое за внимание 🎩! Задавайте вопросы и оставляйте отзыв на лекцию на сайте академии. Успехов с домашкой, скоро увидимся, пока!
</div>
