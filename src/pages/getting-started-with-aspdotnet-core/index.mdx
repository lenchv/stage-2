...
<Level id="intro-to-dotnet-core" number="1" name={<span>Intro to <a href="https://dotnet.microsoft.com/download">.NET Core</a></span>} difficulty="No worries" objectives="Familiarize yourself with .NET basics because you are going to be buddies." />
