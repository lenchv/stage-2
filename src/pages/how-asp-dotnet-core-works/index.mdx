...
Create a new file called `UsersController` in Controllers folder. Add two GET methods which will return a list of users and a user by his id. Use `ValuesController` as an example.
