...
3. <p>Use <strong>pre-commit</strong> git hook <sup><strong><a href="https://git-scm.com/docs/githooks" title="githooks">[1]</a></strong></sup> to generate new <strong>Service Worker</strong> based on <a href="https://developers.google.com/web/tools/workbox/" title="Workbox"><strong>Workbox</strong></a> before each commit</p>
