...
<div id="setting-up-the-repository" class="level">
  <small class="level__info">
    ...
    <a class="level__back-to-top" href="#table-of-contents">
      <FontAwesomeIcon icon={faLongArrowUp} /> back to top
    </a>
  </small>
...
<Level id="research" number="2" name="Research" difficulty="Bring It On!" objectives="Master issues and project management." />
