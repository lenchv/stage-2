...
3. Create a new branch `feature/body` and use it to edit `<body>`:
   ...
   6. Merge both branches into `develop` using pull requests

4. Open a pull request and merge `develop` into `master`
5. Please iterate further and fix bugs, add metadata, implement your own additional features and add more visual effects (if necessary).
5. 💥**Boom, done, готово!** 
