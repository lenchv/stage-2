import { Lecture, Message, TimelineOfContents, Level, RadarChart, ThatsAllFolks } from "../components";
...
5. **Закінчити проект з своїми даними.**  
         ...
         <div>
           <div class="accordion">
             ...
             <label class="accordion-header" for="accordion-1">
               <i class="icon icon-arrow-right"></i> Title
             </label>
