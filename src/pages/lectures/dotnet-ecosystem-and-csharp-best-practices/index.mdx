...
<ul>
  ...
  <li class="details">
    ...
    <div class="details-body" style="margin-bottom: 0.5em;">
      <p><em>Делегати</em> — це об'єкти, які вказують на методи; за допомогою них ми можемо викликати методи, які ми присвоїли делегату.</p>
      ...
      // TODO: Create nested list with accordeons
      <p>Ламбда-вирази мають наступний синтаксис:</p>
