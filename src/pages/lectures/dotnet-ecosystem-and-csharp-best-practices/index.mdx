...
<p style="margin-left: 0.25em;">
  Зараз компанія Microsoft вкладає досить багато ресурсів у розвиток .Net, їхньої клауд платформи - Ажур та найбільше котрибьютить в опен сорс. 
  Інфраструктура .Net стрімко росте та розвивається і постійно створюютсья нові інструменти для роботи з нею.
</p>
<ul>
  <li class="details">
  ...
  <li class="details">
    ...
    <div class="details-body" style="margin-bottom: 0.5em;">
      ...
      <p>Після релізу .NET Core 3.0 в цьому році компанія Microsoft випустить платформу .NET 5, яка стане серйозним поліпшенням системи розробки в цілому.
         Головним нововведенням, в порівнянні з .NET Framework 4.8, буде забезпечення підтримки Linux, macOS, iOS, Android, tvOS, watchOS і WebAssembly. 
         При цьому версія Framework 4.8 залишиться останньою, далі розвиватися буде тільки сімейство Core.
         Розробка зосередиться навколо Runtime, JIT-компілятора, AOT, GC, BCL (Base Class Library), C#, F#, VB.NET, ASP.NET, Entity Framework, ML.NET, WinForms, WPF і Xamarin. 
         Це дозволить уніфікувати платформу і запропонувати єдиний відкритий фреймворк і runtime для різних завдань. В результаті можна буде створювати додатки для різних платформ на загальній кодової базі з однаковим процесом збiрки незалежно від типу програми.
         І розробляти можна буде за допомогою Visual Studio, як під Window так і під Mac, Visual Studio Сode на чому завгодно, ну і обіцяють, що уніфікують CLI і можна багато чого бутстрапити за допомогою консолі.
         Реліз .NET 5 запланований на листопад 2020 року.
      </p>
    </div>
  </li>
  <li class="details">
...
<ul>
  ...
  <li class="details">
    ...
    <div class="details-body" style="margin-bottom: 0.5em;">
      ...
      <p>Інтерфейс в основному використовується тоді, коли ми хочемо просто описати <strong>API</strong> використання класів, які будуть імплементувати цей інтерфейс - задати поведінку.</p>
    </div>
  </li>
   <li class="details">
    ...
    <div class="details-body" style="margin-bottom: 0.5em;">
      <p>IDisposable оголошує єдиний метод Dispose, в якому при імплементації інтерфейсу в класі має відбуватися звільнення некерованих ресурсів, таких як з'єднання з базою данних, файлові дескриптори, мережеві підключення тощо. 
         Некеровані ресурси потрібно звільняти чим пошвидше, ще до видалення об'єкта з пам'яті коли до нього добереться Garbage Collector.
         ...
         І ще така річ, нам самим потрібно явно викликати цей метод Dispose, тому що Garbage Collector нічо про нього не знає. Це найкраще робити у блоці try...finally, щоб навіть якщо виникне помилка ми змогли звільнити ресурси та правильно очистити пам'ять.
      </p>
      <ul>
        <li class="details">
  ...
  <li class="details">
    ...
    <div class="details-body" style="margin-bottom: 0.5em;">
      ...
      <SnippetL03S14 />
      <p>На прикладі показано <em>Extension метод</em> для типу <code>String</code>. Статичний клас може мати довільну назву, в той час як назва методу має відрізнятись від уже існуючих методів у класі, який ми розширюємо, або мати іншу сигнатуру.
      ...
      <ul>
        <li class="details">
          ...
          <label class="summary" for="accordion-3-Generic-example">
            Приклад оголошення Generic класу
          </label>
          <div class="details-body" style="margin-bottom: 0.5em;">
            <SnippetL03S15 />
        ...
        <li class="details">
          ...
          <label class="summary" for="accordion-3-Generic-example-2">
            Приклад створення екземпляру Generic класу
          </label>
          <div class="details-body" style="margin-bottom: 0.5em;">
            <SnippetL03S16 />
  ...
  <li class="details">
    ...
    <div class="details-body" style="margin-bottom: 0.5em;">
      <p>Явно <em>структурному типу даних</em> ми не можемо присвоїти значення<code>null</code>. Щоб це зробити, нам потрібно оголосити змінну з модифікатором <code>?</code>. Цей модифікатор являється аліасом до структури <code>Nullable&lt;T&gt;</code></p>
      <SnippetL03S18 />
  ...
  <li class="details">
    ...
    <div class="details-body" style="margin-bottom: 0.5em;">
      <p><em>Делегати</em> — це об'єкти, які вказують на методи; за допомогою них ми можемо викликати методи, які ми присвоїли делегату. Делегати дозволяють представляти методи у вигляді об'єктів і передавати їх до функцій, використовувати як колбеки.</p>
      <p><em>Події</em> — це об'єкти типу делегат, які повідомляють про це що сталась якась подія (відбувся <em>action</em>).</p>
      <p><em>Лямбда-вирази</em> — представляють з себе спрощений запис анонімних методів. Це дозволяє створити лаконічні методи, які можуть повертати якесь значення.</p>
      <ul>
        <li class="details">
        ...
        <li class="details">
         ...
         <li class="details">
          ...
          <div class="details-body" style="margin-bottom: 0.5em;">
            ...
            <p>Існує така модель: Publisher-Subscriber(Видавець-Підписник). Підписник підписується на подію, визначає обробник і чекає допоки Видавець виконає цю подію, щоб його викликати.</p>
            {/* // TODO: Add link to real repository */}            
            <p>Приклад використання подій та делегатів ви зможете знайти за посиланням на <a href="#">репозиторій</a> із кодом з лекції</p>
          </div> 
        </li>
      </ul>
    </div>
  ...
  <li class="details">
    ...
    <div class="details-body" style="margin-bottom: 0.5em;">
      ...
      <p>Інтерфейс <em>IEnumerator</em> представляє <em>Перечислитель</em>, який уможливлює послідовний перебір колекції, наприклад в циклі <em>foreach</em>, або засобами <a href="https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/linq/">LINQ</a>. А інтерфейс <em>IEnumerable</em> через свій метод <em>GetEnumerator</em> надає Перечислитель всім класам, які реалізують даний інтерфейс. Тому інтерфейс <em>IEnumerable</em> є базовим для усіх колекцій.</p>
      ...
      <ul>
        ...
        <li class="details">
          ...
          <div class="details-body" style="margin-bottom: 0.5em;">
            <p><code>Stack&lt;T&gt;</code> представляє колекцію, яка використовує алгоритм LIFO - last in - first out - ("останній прийшов - першим вийшов"). При такій організації даних кожен наступний доданий елемент поміщається поверх попереднього. Діставання елементів з колекції відбувається в зворотному порядку - витягується той елемент, який знаходиться вище всіх у стеці.</p> 
            <img src={stack} alt="stack" />
            <p>У класі Stack можна виділити два основні методи, які дозволяють керувати елементами - це:</p>
            <ul>
        ...
        <li class="details">
          ...
          <div class="details-body" style="margin-bottom: 0.5em;">
            <p><code>Dictionary</code> (словник) зберігає об'єкти, які представляють пару ключ-значення. Його дуже зручно використовувати для того щоб огранізувати відповідність чогось чомусь.</p> 
  ...
  <li class="details">
    ...
    <div class="details-body" style="margin-bottom: 0.5em;">
      <p>Якщо вам потрібно склеїти два значення, щоб повернути їх з функції або помістити два значення в хеш-набір, ви можете використовувати типи System.ValueTuple</p>
      <ul>
        <li class="details">
        ...
        <li class="details">
          ...
          <div class="details-body" style="margin-bottom: 0.5em;">
            ...
            <ol>
              ...
              <li>Додавання елементів кортежу у Dictionary</li>
    ...
    <div class="details-body" style="margin-bottom: 0.5em;">
      ...
      <ul>
        ...
        <li class="details">
          ...
          <div class="details-body" style="margin-bottom: 0.5em;">
            <p>У C# всі типи Exception-ів наслідуються від батьківського класу Exception, який додатково поділяється на дві гілки SystemException і ApplicationException.</p>
            <p>SystemException - це базовий клас для всіх помилок CLR або програмного коду, таких як DivideByZeroException або NullReferenceException і так далі.</p>
        ...
        <li class="details">
          ...
          <div class="details-body" style="margin-bottom: 0.5em;">
            <p>ApplicationException використовується для виключень пов'язаних із додатком. Такий тип викключень дуже зручно використовувати для створення своїх кастомних Exception-ів. Для цього треба просто унаслідуватись від класу Exception і додати туда те що ви хочете. Далі в цьому класі можна визначати додаткої поля, властивості, методи і тд.</p>
            <SnippetL03S30 />
          </div>
        </li>
        <li class="details">
        ...
        <li class="details">
          ...
          <div class="details-body" style="margin-bottom: 0.5em;">
            <p>Після оператора <code>throw</code> вказується об'єкт <code>Exception</code>-a, в конструктор якого ми можемо передати повідомлення про помилку. Замість загального типу Exception ми можемо вказати  об'єкт будь-якого іншого типу <code>Exception</code>.</p>
            <SnippetL03S33 />
  ...
  {/* // TODO: Add link to real repository */}
  <p>Приклад обробки виняткових ситуацій ви зможете знайти за посиланням на <a href="#">репозиторій</a> із кодом з лекції</p>  
</ul>
...
<ul>
  ...
  <li class="details">
    ...
    <div class="details-body" style="margin-bottom: 0.5em;">
      ...
      <p>А якщо простіше, то це правила, дотримуючись який, ви будете писати код, який буде легко зрозуміти, змінити чи замінити та використати повторно.</p>
      <ul>
        <li class="details">
