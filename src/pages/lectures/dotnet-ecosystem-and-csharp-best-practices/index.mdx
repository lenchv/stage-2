...
<ul>
  ...
  <li class="details">
    ...
    <div class="details-body" style="margin-bottom: 0.5em;">
      <img src={dotnet5Platform} alt="dotnet-5-platform" />
      <p>Після релізу .NET Core 3.0 в цьому році компанія Microsoft випустить платформу <strong>.NET 5</strong>, яка стане серйозним поліпшенням системи розробки в цілому. Головним нововведенням, в порівнянні з .NET Framework 4.8, буде забезпечення підтримки Linux, macOS, iOS, Android, tvOS, watchOS і WebAssembly. При цьому версія Framework 4.8 залишиться останньою, далі розвиватися буде тільки сімейство Core. Розробка зосередиться навколо <strong>Runtime</strong>, <strong>JIT-компілятора</strong>, <strong>AOT</strong>, <strong>GC</strong>, <strong>BCL (Base Class Library)</strong>, <strong>C#</strong>, <strong>F#</strong>, <strong>VB.NET</strong>, <strong>ASP.NET</strong>, <strong>Entity Framework</strong>, <strong>ML.NET</strong>, <strong>WinForms</strong>, <strong>WPF</strong> і <strong>Xamarin</strong>. Це дозволить уніфікувати платформу і запропонувати єдиний відкритий фреймворк і runtime для різних завдань. В результаті можна буде створювати додатки для різних платформ на загальній кодової базі з однаковим процесом збiрки незалежно від типу програми. І розробляти можна буде за допомогою Visual Studio (як під Windows так і під Mac) або Visual Studio Сode (з існуючими дистрибутивами та браузерною версією — на чому завгодно), також нам обіцяють, що уніфікують CLI і дадуть моживість бутстрапити за допомогою консолі. Реліз .NET 5 запланований на листопад 2020 року.
      </p>
    </div>
  </li>
  <li class="details">
...
export const metadata = {
  ...
  publishedAt: "2019-05-15T22:00:00"
}
