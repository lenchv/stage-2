...
<p style="margin-left: 0.25em;">
  Зараз компанія Microsoft вкладає досить багато ресурсів у розвиток .NET та їхньої хмарної платформи — Azure <em>(Ажур, Ежур, Ейжа)</em> та найбільше котрибьютить в open source. 
  Інфраструктура .NET стрімко росте та розвивається і для роботи з нею постійно створюютсья нові інструменти.
</p>
<ul>
  <li class="details">
  ...
  <li class="details">
    ...
    <div class="details-body" style="margin-bottom: 0.5em;">
      ...
      <p>Після релізу .NET Core 3.0 в цьому році компанія Microsoft випустить платформу .NET 5, яка стане серйозним поліпшенням системи розробки в цілому.
         ...
         І розробляти можна буде за допомогою Visual Studio (як під Windows так і під Mac) або Visual Studio Сode (з існуючими дистрибутивами та браузерною версією — на чому завгодно), також нам обіцяють, що уніфікують CLI і дадуть моживість бутстрапити за допомогою консолі.
...
<ul>
  ...
  <li class="details">
    ...
    <div class="details-body" style="margin-bottom: 0.5em;">
      ...
      <p>Інтерфейс <em>IEnumerator</em> представляє <em>Перераховувач (Перечислитель)</em>, який уможливлює послідовний перебір колекції, наприклад в циклі <em>foreach</em>, або засобами <a href="https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/linq/">LINQ</a>. А інтерфейс <em>IEnumerable</em> через свій метод <em>GetEnumerator</em> надає Перераховувач всім класам, які реалізують даний інтерфейс. Тому інтерфейс <em>IEnumerable</em> є базовим для усіх колекцій.</p>
