...
<p style="margin-left: 0.25em;">
  Зараз компанія Microsoft вкладає досить багато ресурсів у розвиток .NET, їхньої клауд платформи - <strong>Azure</strong> та багато котрибьютить в open-source. 
  ...
  <li class="details">
    ...
    <div class="details-body" style="margin-bottom: 0.5em;">
      ...
      <p>Після релізу <strong>.NET Core 3.0</strong> в цьому році компанія Microsoft випустить платформу <strong>.NET 5</strong>, яка стане серйозним поліпшенням системи розробки в цілому.
         ...
         І розробляти можна буде за допомогою <strong>Visual Studio</strong>, <strong>Visual Studio for Mac</strong>, <strong>Visual Studio Сode</strong> - на чому завгодно, ну і обіцяють, що уніфікують <strong>CLI</strong> і можна багато чого бутстрапити за допомогою консолі.
      </p>
