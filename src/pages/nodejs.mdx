...
import alexandrTovmachAvatar from "../assets/avatars/alexandr-tovmach.svg";
...
<div>
  <div class="author">
    <div id="avatar-wrapper">
      <object id="avatar" data={alexandrTovmachAvatar} role="img" aria-label="Alex profile picture"></object>
    </div>
    <div class="profile">
...
<div class="messages">
  Ryu очень доволен тем что у него есть свой собственный онлайн-файтинг, которым он хвастается перед всеми своими друзьями. 
  <Message
    senderId="ryu"
    senderName="Ryu"
